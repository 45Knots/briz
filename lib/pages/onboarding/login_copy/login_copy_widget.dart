                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'zaqkk670' /* Use the form below to access y... */,
                              ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'viiy9b9o' /* Email Address */,
                                        ),
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .bodySmall,
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          '6l34qvjx' /* Enter your email here... */,
                                        ),
                                ...
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'zuowmjad' /* Enter your email here... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall,
                                      enabledBorder: OutlineInputBorder(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    '1i3fyzuw' /* Don't have an account? */,
                                  ),
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                ),
