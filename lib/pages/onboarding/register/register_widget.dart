                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'ixr3g4d6' /* Email Address */,
                                    ),
                                    labelStyle:
                                        FlutterFlowTheme.of(context).bodySmall,
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '2ssc16rc' /* Enter your email here... */,
                                    ),
                                    hintStyle:
                                        FlutterFlowTheme.of(context).bodySmall,
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'cjny9m2f' /* Enter your email here... */,
                                  ),
                                  hintStyle:
                                      FlutterFlowTheme.of(context).bodySmall,
                                  enabledBorder: OutlineInputBorder(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                't2b0szfj' /* Confirm Password */,
                              ),
                              labelStyle:
                                  FlutterFlowTheme.of(context).bodySmall,
                              hintText: FFLocalizations.of(context).getText(
                                'igt5uvv1' /* Enter your email here... */,
                              ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'ft8wkh1a' /* Already have an account? */,
                              ),
                              style: FlutterFlowTheme.of(context).bodyMedium,
                            ),
                            FFButtonWidget(
